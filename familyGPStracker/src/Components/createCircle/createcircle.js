...
import {
    ...
    Left, Body, Right, Button, Icon, Title, Form, Item,
    Input, Label
} from 'native-base';
...
function mapDispatchToProps(dispatch) {
    return {
        createCircle: (users) => dispatch(CircleMiddleware.createCircle(users)),
    }
}
...
class CreateCircle extends Component {
    ...
    create = () => {
        ...
        this.props.createCircle(userCircle);
        this.setState({
            circleName: '',
        })
    }
                ...
                <Content>
                    <Form>
                        ...
                        <Button block rounded onPress={this.create}
                            style={{ marginTop: 30, padding: 10, width: 120, alignSelf: 'center' }}>
